...
import com.dotnar.bean.QrcodeTicket;
...
public class QrcodeAPI extends BaseAPI{
	 ...
	 * @return
	 */
	private static QrcodeTicket qrcodeCreate(String access_token,String qrcodeJson) throws Exception {
	 ...
	 * @return
	 */
	private static QrcodeTicket qrcodeCreate(String access_token,Integer expire_seconds,String action_name,long scene_id) throws Exception {
	 ...
	 * @return
	 */
	public static QrcodeTicket qrcodeCreateTemp(String access_token,int expire_seconds,long scene_id) throws Exception {
	 ...
	 * @return
	 */
	public static QrcodeTicket qrcodeCreateFinal(String access_token,int scene_id) throws Exception {
	 ...
	 * @return
	 */
	public static byte[] showqrcode(String ticket) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
