...
public class SnsAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static SnsToken oauth2AccessToken(String appid,String secret,String code) throws Exception {
	 ...
	 * @return
	 */
	public static SnsToken oauth2ComponentAccessToken(String appid,String code,String component_appid,String component_access_token ) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static SnsToken oauth2RefreshToken(String appid,String refresh_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static SnsToken oauth2ComponentRefreshToken(String appid,String refresh_token,String component_appid,String component_access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static User userinfo(String access_token,String openid,String lang) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static String connectOauth2Authorize(String appid,String redirect_uri,boolean snsapi_userinfo,String state) throws Exception {
	 ...
	 * @return
	 */
	public static String connectOauth2Authorize(String appid,String redirect_uri,boolean snsapi_userinfo,String state,String component_appid) throws Exception {
		try {
