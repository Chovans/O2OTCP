...
public class PayMchAPI extends BaseAPI {
     ...
     */
    @Deprecated
    public static UnifiedorderResult payUnifiedorder(Unifiedorder unifiedorder) throws Exception {
     ...
     * @return
     */
    public static MicropayResult payMicropay(Micropay micropay, String key) throws Exception {
     ...
     * @return
     */
    public static MchOrderInfoResult payOrderquery(MchOrderquery mchOrderquery, String key) throws Exception {
     ...
     * @return
     */
    public static MchBaseResult payCloseorder(Closeorder closeorder, String key) throws Exception {
     ...
     * @return
     */
    public static SecapiPayRefundResult secapiPayRefund(SecapiPayRefund secapiPayRefund, String key) throws Exception {
     ...
     * @return
     */
    public static MchReverseResult secapiPayReverse(MchReverse mchReverse, String key) throws Exception {
     ...
     * @return
     */
    public static RefundqueryResult payRefundquery(Refundquery refundquery, String key) throws Exception {
     ...
     * @return
     */
    public static MchBaseResult payDownloadbill(MchDownloadbill downloadbill, String key) throws Exception {
     ...
     * @return
     */
    public static MchShorturlResult toolsShorturl(MchShorturl shorturl, String key) throws Exception {
     ...
     * @return
     */
    public static MchBaseResult payitilReport(Report report, String key) throws Exception {
     ...
     * @return
     */
    public static SendCouponResult mmpaymkttransfersSend_coupon(SendCoupon sendCoupon, String key) throws Exception {
     ...
     * @return
     */
    public static QueryCouponStockResult mmpaymkttransfersQuery_coupon_stock(QueryCouponStock queryCouponStock, String key) throws Exception {
     ...
     * @return
     */
    public static QueryCouponResult promotionQuery_coupon(QueryCoupon queryCoupon, String key) throws Exception {
     ...
     * @return
     */
    public static SendredpackResult mmpaymkttransfersSendredpack(Sendredpack sendredpack, String key) throws Exception {
     ...
     * @return
     */
    public static SendredpackResult mmpaymkttransfersSendgroupredpack(Sendgroupredpack sendgroupredpack, String key) throws Exception {
     ...
     * @return
     */
    public static TransfersResult mmpaymkttransfersPromotionTransfers(Transfers transfers, String key) throws Exception {
