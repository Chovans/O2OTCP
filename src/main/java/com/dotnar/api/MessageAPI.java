...
import com.dotnar.bean.*;
import com.dotnar.bean.massmessage.MassMessage;
import com.dotnar.bean.message.Message;
import com.dotnar.bean.templatemessage.TemplateMessage;
import com.dotnar.bean.templatemessage.TemplateMessageResult;
...
public class MessageAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static BaseResult messageCustomSend(String access_token,String messageJson) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult messageCustomSend(String access_token,Message message) throws Exception {
	 ...
	 * @return
	 */
	public static Media mediaUploadnews(String access_token,List<Article> articles) throws Exception {
	 ...
	 * @return
	 */
	public static Media mediaUploadvideo(String access_token,Uploadvideo uploadvideo) throws Exception {
	 ...
	 * @return
	 */
	public static MessageSendResult messageMassSendall(String access_token,String messageJson) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
										.setHeader(jsonHeader)
	 ...
	 * @return
	 */
	public  static MessageSendResult messageMassSendall(String access_token,MassMessage massMessage) throws Exception {
	 ...
	 * @return
	 */
	public static MessageSendResult messageMassSend(String access_token,String messageJson) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
										.setHeader(jsonHeader)
	 ...
	 * @return
	 */
	public static MessageSendResult messageMassSend(String access_token,MassMessage massMessage) throws Exception {
		String str = JsonUtil.toJSONString(massMessage);
	 ...
	 * @return
	 */
	public static BaseResult messageMassDelete(String access_token,String msgid) throws Exception {
	 ...
	 * @return
	 */
	public static TemplateMessageResult messageTemplateSend(String access_token,TemplateMessage templateMessage) throws Exception {
