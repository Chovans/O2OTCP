...
import com.dotnar.bean.Article;
import com.dotnar.bean.BaseResult;
import com.dotnar.bean.Media;
import com.dotnar.bean.MediaType;
import com.dotnar.bean.material.Description;
import com.dotnar.bean.material.MaterialBatchgetResult;
import com.dotnar.bean.material.MaterialcountResult;
import com.dotnar.bean.material.NewsItem;
...
public class MaterialAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static Media materialAdd_news(String access_token,List<Article> articles) throws Exception {
	 ...
	 * @return
	 */
	public static Media materialAdd_material(String access_token,MediaType mediaType,File media,Description description) throws Exception {
	 ...
	 * @return
	 */
	public static Media materialAdd_material(String access_token,MediaType mediaType,InputStream inputStream,Description description) throws Exception {
		HttpPost httpPost = new HttpPost(MEDIA_URI+"/cgi-bin/material/add_material");
	 ...
	 * @return
	 */
	public static Media materialAdd_material(String access_token,MediaType mediaType,URI uri,Description description) throws Exception {
		HttpPost httpPost = new HttpPost(MEDIA_URI+"/cgi-bin/material/add_material");
	 ...
	 * @return
	 */
	public static byte[] materialGet_material(String access_token,String media_id) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return NewsItem
	 */
	public static NewsItem materialGet_material_newsItem(String access_token,String media_id) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
					.setUri(BASE_URI+"/cgi-bin/material/get_material")
					.addParameter("access_token", access_token)
					.setEntity(new StringEntity("{\"media_id\":\""+media_id+"\"}",Charset.forName("utf-8")))
	 ...
	 * @return
	 */
	public static BaseResult materialDel_material(String access_token,String media_id) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static BaseResult materialUpdate_news(String access_token,String media_id,int index,List<Article> articles) throws Exception {
		String str = JsonUtil.toJSONString(articles);
	 ...
	 * @return
	 */
	public static MaterialcountResult materialGet_materialcount(String access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static MaterialBatchgetResult materialBatchget_material(String access_token,String type,int offset,int count) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
