...
public class UserAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static User userInfo(String access_token,String openid) throws Exception {
	 ...
	 * @return
	 */
	public static FollowResult userGet(String access_token,String next_openid) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static UserInfoList userInfoBatchget(String access_token,String lang,List<String> openids) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult userInfoUpdateremark(String access_token,String openid,String remark) throws Exception {
	 ...
	 * @return
	 */
	public static Group groupsCreate(String access_token,String name) throws Exception {
	 ...
	 * @return
	 */
	public static Group groupsGet(String access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static Group groupsGetid(String access_token,String openid) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult groupsUpdate(String access_token,String id,String name) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult groupsMembersUpdate(String access_token,String openid,String to_groupid) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult groupsMembersBatchUpdate(String access_token,List<String> openid_list,String to_groupid) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult groupsDelete(String access_token,String id) throws Exception {
