...
public class ShorturlAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static Shorturl shorturl(String access_token,String action,String long_url) throws Exception {
	 ...
	 * @return
	 */
	public static Shorturl shorturl(String access_token,String long_url) throws Exception {
