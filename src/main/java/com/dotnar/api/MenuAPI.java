...
import com.dotnar.bean.Menu;
import com.dotnar.bean.MenuButtons;
import com.dotnar.bean.selfmenu.CurrentSelfmenuInfo;
...
public class MenuAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static BaseResult menuCreate(String access_token,String menuJson) throws Exception {
	 ...
	 * @return
	 */
	public static BaseResult menuCreate(String access_token,MenuButtons menuButtons) throws Exception {
	 ...
	 * @return
	 */
	public static Menu menuGet(String access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static BaseResult menuDelete(String access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return
	 */
	public static CurrentSelfmenuInfo get_current_selfmenu_info(String access_token) throws Exception {
		HttpUriRequest httpUriRequest = RequestBuilder.post()
