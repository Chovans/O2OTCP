...
import com.dotnar.aes.AesException;
import com.dotnar.aes.WXBizMsgCrypt;
import com.dotnar.bean.EventMessage;
import com.dotnar.bean.xmlmessage.XMLTextMessage;
import com.dotnar.util.ExpireSet;
import com.dotnar.util.SignatureUtil;
import com.dotnar.util.StreamUtils;
...
public class ReceiveServlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	...
    	//加密方式
    	boolean isAes = "com/dotnar/aes".equals(encrypt_type);
    	if(isAes){
    		try {
